...
layui.define(['laytpl', 'layer'], function (exports) {
  ...
  view.exit = function () {
    ...
    //跳转到登入页
    location.hash = '/WDHindPage/user/login';
  };
  ...
  view.req = function (options) {
    ...
    if (request.tokenName) {
      ...
      //自动给 Request Headers 传入 其他必要header
      options.headers[request.userId] = request.userId in options.headers ?
        options.headers[request.userId] :
        (layui.data(setter.tableName)[request.userId] || '');
    }
